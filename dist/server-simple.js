...
app.get('/api/v1/lorry-requests', authMiddleware, (req, res) => {
    const mockRequests = [
        {
            id: '1',
...
app.post('/api/v1/lorry-requests', authMiddleware, (req, res) => {
...
app.post('/api/v1/lorry-requests/:id/approve', authMiddleware, (req, res) => {
...
app.post('/api/v1/lorry-requests/:id/reject', authMiddleware, (req, res) => {
...
app.get('/api/v1/organizations/:orgId/farmers', authMiddleware, (req, res) => {
    const mockFarmers = [
        {
            id: '1',
            name: 'John Doe',
...
app.get('/api/v1/lorries', authMiddleware, (req, res) => {
    const mockLorries = [
        {
            id: '1',
            organizationId: req.user.organizationId,
...
app.get('/api/v1/organizations/:orgId/lorries', authMiddleware, (req, res) => {
    const mockLorries = [
        {
            id: '1',
