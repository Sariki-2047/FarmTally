...
async function main() {
    ...
    const fieldManager = await prisma.user.create({
        data: {
            ...
            phone: '+91-9876543211',
            passwordHash: await bcryptjs_1.default.hash('Manager123!', 10),
            role: client_1.UserRole.FIELD_MANAGER,
    ...
    const lorries = await Promise.all([
        ...
        prisma.lorry.create({
            data: {
                ...
                capacity: 1500,
                status: client_1.LorryStatus.ASSIGNED,
